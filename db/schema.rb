...
ActiveRecord::Schema.define(version: 20170528124235) do
  ...
  create_table "propostas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "nome", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cidade_id"], name: "index_propostas_on_cidade_id"
  end

  add_foreign_key "propostas", "cidades"
end
